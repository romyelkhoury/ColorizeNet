...
try:
    # If PyTorch version >= 1.6.0, torch.cpu.amp.autocast would be imported
...
def auto_fp16(apply_to=None, out_fp32=False):
    ...
    ignored. If you are using PyTorch >= 1.6, torch.cpu.amp is used as the
...
def force_fp32(apply_to=None, out_fp16=False):
    ...
    torch.cpu.amp is used as the backend, otherwise, original mmcv
...
def wrap_fp16_model(model):
    ...
    If you are using PyTorch >= 1.6, torch.cpu.amp is used as the
    backend, otherwise, original mmcv implementation will be adopted.
