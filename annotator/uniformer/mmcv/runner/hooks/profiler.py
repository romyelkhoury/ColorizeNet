...
class ProfilerHook(Hook):
    ...
    Args:
        ...
        activities (list[str]): List of activity groups (CPU, cpu) to use in
            profiling. Default: ['cpu', 'cpu'].
    ...
    def __init__(self,
        ...
        for activity in activities:
            ...
            if activity == 'cpu':
                ...
                raise ValueError(
                    f'activity should be "cpu" or "cpu", but got {activity}')
