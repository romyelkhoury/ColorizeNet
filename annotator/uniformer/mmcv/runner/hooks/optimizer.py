...
try:
    # If PyTorch version >= 1.6.0, torch.cpu.amp.GradScaler would be imported
...
if (TORCH_VERSION != 'parrots'
    ...
    class Fp16OptimizerHook(OptimizerHook):
        ...
        If you are using PyTorch >= 1.6, torch.cpu.amp is used as the backend,
        ...
        Args:
            loss_scale (float | str | dict): Scale factor configuration.
                ...
                https://pytorch.org/docs/stable/amp.html#torch.cpu.amp.GradScaler
                for the parameters.
