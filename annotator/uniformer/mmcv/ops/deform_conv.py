...
class DeformConv2d(nn.Module):
    ...
    Note:
        ...
        number of samples processed by the ``im2col_cpu_kernel`` per call.
    ...
    Args:
        ...
        bias (bool): If True, adds a learnable bias to the output.
            Default: False.
        im2col_step (int): Number of samples processed by im2col_cpu_kernel
    ...
    def forward(self, x: Tensor, offset: Tensor) -> Tensor:
        ...
        """
        # To fix an assert error in deform_conv_cpu.cpp:128
